...
public class PublisherRepositoryImplTest {
    ...
    void testFindAllPublisher() {
        ...
        assertEquals(true, publishers.size()>0);
    ...
    void testCreatePublisher() {
        ...
        int initialSize = publisherRepository.findAllPublishers().size();
        ...
        assertEquals(initialSize+1, publisherRepository.findAllPublishers().size());
    }

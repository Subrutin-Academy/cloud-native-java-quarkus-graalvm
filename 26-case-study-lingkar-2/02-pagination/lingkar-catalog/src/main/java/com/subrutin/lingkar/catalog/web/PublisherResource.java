...
public class PublisherResource {
    ...
    @GET
    public RestResponse<ResultPageResponseDTO<PublisherListResponseDTO>> findPublisherList(
        @QueryParam("pages") @DefaultValue("0") Integer pages,
        @QueryParam("limit") @DefaultValue("10") Integer limit,
        @QueryParam("sortBy") @DefaultValue("name") String sortBy,
        @QueryParam("direction") @DefaultValue("asc") String direction,
        @QueryParam("publisherName") String publisherName
    ){
        return RestResponse.ok(publisherService.findPubliherList(pages, limit, sortBy, direction, publisherName));

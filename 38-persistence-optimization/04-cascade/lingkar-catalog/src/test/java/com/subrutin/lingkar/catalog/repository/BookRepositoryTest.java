...
public class BookRepositoryTest {
    ...
    @Test @Transactional
    void testFetchDirectBookByIdUsingJpaProjection() {
        BookQueryDTO book = bookRepository.findBookByIdUsingJpaProjection(1L)
            .orElseThrow(() -> new ResourceNotFoundException("Book not found"));
        assertEquals("Laskar Pelangi", book.bookTitle());
    }
